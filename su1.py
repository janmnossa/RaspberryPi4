...
TRIG = 20 #Variable que contiene el GPIO al cual conectamos la señal TRIG del sensor
ECHO = 21 #Variable que contiene el GPIO al cual conectamos la señal ECHO del sensor
